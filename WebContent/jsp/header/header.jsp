		...
		<header class="header blue-bg">
			...
			<div class="nav notify-row" id="top_menu">
				...
				<ul class="nav top-menu">
					...
					<li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i class="fa fa-tasks"></i> <span class="badge bg-success">6</span>
					</a>
			...
			<div class="top-nav ">
				<ul class="nav pull-right top-menu">
					...
					<li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#"> <img alt="" src="/obigoProject/img/obigo_logo_small.png"> <span class="username">SUPERWYH</span> <b
							class="caret"></b>
					</a>
