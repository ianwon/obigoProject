...
<link href="/obigoProject/assets/xchart/xcharts.css" rel="stylesheet" />
<!--right slidebar-->
...
<body>
	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper site-min-height">
				<!-- page start-->
				<section class="panel">
					<header class="panel-heading"> xCharts Basic Example </header>
	...
	<script src="/obigoProject/assets/xchart/d3.v3.min.js"></script>
	<script src="/obigoProject/assets/xchart/xcharts.min.js"></script>
